...
export default function Footer() {
  ...
  const contactEmail =
    globalSettings?.contactEmail || 'apostoladonewman@gmail.com';
  const contactPhone = globalSettings?.contactPhone || '+55 63 99225-9781';
  const whatsappUrl =
    globalSettings?.whatsappUrl || 'https://wa.me/5563992259781';
        ...
        <div className="grid gap-12 md:grid-cols-3 text-center md:text-left mb-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 justify-center md:justify-start group">
              <div className="relative">
                ...
                <img
                  ...
                  className="h-10 w-10 opacity-90 relative z-10"
                />
              </div>
              <div>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Testemunhos e reflexões de quem encontrou a plenitude da fé
              católica, inspirados pela vida e obra de São João Henrique Newman.
            </p>
          </div>
        ...
        <div className="border-t border-border/40 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
            ...
            <div className="flex items-center gap-2">
              <span className="motto-text font-medium italic">
