...
export default function Biblioteca() {
  ...
  const totalBooks = booksGrouped
    ? Object.values(booksGrouped).reduce((acc, books) => acc + books.length, 0)
    : 0;
  const totalCategories = filteredBooksGrouped
    ? Object.keys(filteredBooksGrouped).length
    : 0;
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Biblioteca com obras católicas recomendadas para aprofundamento espiritual e intelectual."
        />
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-b from-background via-primary/[0.02] to-background">
          ...
          <div className="container relative mx-auto px-4 py-16 md:py-20">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                Obras clássicas e contemporâneas para aprofundamento espiritual
                e intelectual na fé católica
              </p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Estamos trabalhando para disponibilizar mais recursos
                      digitais para download. Alguns livros já podem ser
        ...
        <section className="container mx-auto px-4 py-12 md:py-16">
          <div className="max-w-7xl mx-auto">
            {!filteredBooksGrouped ||
            Object.keys(filteredBooksGrouped).length === 0 ? (
              ...
              <div className="space-y-12">
                {Object.entries(filteredBooksGrouped).map(
                  ([category, books]) => (
