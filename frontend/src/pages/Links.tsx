...
export default function Links() {
  ...
  const totalLinks = linksGrouped
    ? Object.values(linksGrouped).reduce((acc, links) => acc + links.length, 0)
    : 0;
  const totalCategories = filteredLinksGrouped
    ? Object.keys(filteredLinksGrouped).length
    : 0;
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Recursos, sites e referências católicas para aprofundamento na fé."
        />
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-b from-background via-primary/[0.02] to-background">
          ...
          <div className="container relative mx-auto px-4 py-16 md:py-20">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                Explore recursos, sites e referências para aprofundar seu
        ...
        <section className="container mx-auto px-4 py-12 md:py-16">
          <div className="max-w-6xl mx-auto">
            {!filteredLinksGrouped ||
            Object.keys(filteredLinksGrouped).length === 0 ? (
              ...
              <div className="space-y-12">
                {Object.entries(filteredLinksGrouped).map(
                  ([category, links]) => (
