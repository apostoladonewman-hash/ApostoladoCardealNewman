...
const Index = () => {
  ...
  if (articlesError || testimonialsError) {
    return (
      <ErrorMessage error={(articlesError || testimonialsError) as Error} />
    );
  }
  ...
  return (
    <div>
        ...
        <div className="container relative grid md:grid-cols-2 gap-16 py-20 md:py-32 items-center">
          <div className="space-y-8 relative z-10">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground/90 max-w-prose leading-relaxed">
              Testemunhos e artigos de quem, vindo do protestantismo, encontrou
              a{' '}
            ...
            <blockquote className="relative border-l-4 border-primary/30 pl-6 py-3 italic text-lg text-muted-foreground bg-gradient-to-r from-primary/5 to-transparent rounded-r">
              <p className="mb-2">
                &quot;Crescer é mudar, e ser perfeito é ter mudado muitas
                vezes.&quot;
              </p>
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <Button
                asChild
                size="lg"
                className="bg-gradient-to-br from-[hsl(var(--primary))] to-[hsl(var(--gold-warm))] hover:from-[hsl(var(--bronze))] hover:to-[hsl(var(--primary))] text-white shadow-lg hover:shadow-xl transition-all"
              >
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="border-2 border-[hsl(var(--bronze))]/30 hover:border-[hsl(var(--bronze))] hover:bg-[hsl(var(--primary))]/5"
              >
        ...
        <div className="container relative">
          <header className="mb-16 text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Testemunhos autênticos de quem encontrou a plenitude da fé na
              Igreja Católica
            </p>
          </header>
      ...
      <section
        id="artigos"
        className="py-20 md:py-28 relative bg-gradient-to-b from-primary/[0.02] via-transparent to-transparent"
      >
        <div className="container relative">
          <header className="mb-16 text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Estudos e meditações para aprofundar seu conhecimento da fé
              católica
            </p>
          </header>
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {articles.length === 0 ? (
              ...
              articles.map((article) => {
                const authorName =
                  article.author?.nome_pessoa || 'Autor Desconhecido';
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="relative rounded-2xl bg-card border border-border/50 p-8 shadow-sm hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                Assista nossos vídeos com testemunhos de conversão, reflexões
                sobre a fé católica e muito mais.
              </p>
            ...
            <div className="relative rounded-2xl bg-card border border-border/50 p-8 shadow-sm hover:shadow-xl transition-all duration-300">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    @apostoladocardealnewman
                  </p>
                </div>
              </div>

              <p className="text-muted-foreground mb-6 leading-relaxed">
                Siga-nos no Instagram para conteúdos diários, citações
                inspiradoras e atualizações do apostolado.
              </p>
      ...
      <section id="assine" className="py-24 md:py-32 relative overflow-hidden">
        ...
        <div className="container max-w-3xl text-center relative z-10">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-10">
            Assine nossa newsletter e receba novos depoimentos de conversão e
            artigos sobre a fé católica diretamente em sua caixa de entrada.
          </p>
